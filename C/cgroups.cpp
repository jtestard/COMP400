...
int main(int argc, char **argv, char **envp) {
	...
	char some_string[1024] = "";
	...
	for (i = 0; i < numMegaBytes; i++) {
		...
		//Now fill in the malloc with some data.
		strcpy(mallocs[i],some_string);
		for (j=0; j<ALLOC_SIZE-1; j++)
			strcat(mallocs[i],some_string);
